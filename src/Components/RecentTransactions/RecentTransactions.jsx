                  ...
                  {editIndex === index ? (
                    ...
                    <div style={{ marginLeft: "auto" }}>
                      ...
                      >
                        ...
                        >
                          <CiEdit style={{height:"24px",width:"24px"}}/>
                        </button>
                        <button
                          style={{
                            width: "3rem",
                        ...
                        >
                          <MdCancel style={{height:"24px",width:"24px"}}/>
                        </button>
                      </div>
                    </div>
                  )}
...
const getIconForTitle = (category) => {
  switch (category.toLowerCase()) {
    case "food":
      return <MdOutlineFoodBank style={{height:"24px",width:"24px"}} />;

    case "shopping":
      return <GiClothes style={{height:"24px",width:"24px"}}/>;

    case "entertainment":
      return <MdMovieCreation style={{height:"24px",width:"24px"}}/>;

    case "travel":
      return <FaBusSimple style={{height:"24px",width:"24px"}}/>;

    default:
      return <MdDisabledByDefault style={{height:"24px",width:"24px"}}/>; 
  }
};
